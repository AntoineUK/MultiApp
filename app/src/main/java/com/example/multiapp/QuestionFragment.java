...
public class QuestionFragment extends Fragment {
    ...
    public QuestionMultiple[] mQuestionBank;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        QuestionMultiple[] questions = p.makeQuestions(data2);
        for (QuestionMultiple q : questions) {
            db.addQuestion(q);
        }

        QuestionMultiple[] temp = new QuestionMultiple[]{new QuestionMultiple(100, "Click next to begin", new String[]{}, new ArrayList<ArrayList<String>>(), new byte[5], "easy", "blank"), new QuestionMultiple(100, "Click next to begin", new String[]{}, new ArrayList<ArrayList<String>>(), new byte[5], "easy", "blank")};
        mQuestionBank = temp;
    ...
    public void getQuestions() {
        QuestionMultiple[] temp = DB.getAllQuestions(difficulty);
        QuestionMultiple[] switcher = new QuestionMultiple[10];
        for (int i = 0; i < 10; i++) {
            switcher[i] = temp[i];
        }
