...
public class QuestionMultiple {
    ...
    public QuestionMultiple(int pID, String pQuestion, String[] pOptions, ArrayList<ArrayList<String>> pAnswers, byte[] pPicture, String pDifficulty, String pExplanation) {
        mID = pID;
        mQuestion = pQuestion;
        mOptions = pOptions;
        mAnswers = pAnswers;
